<div class="screeningFormats view">
<h2><?php  __('ScreeningFormat');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit ScreeningFormat', true), array('action'=>'edit', $screeningFormat['ScreeningFormat']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete ScreeningFormat', true), array('action'=>'delete', $screeningFormat['ScreeningFormat']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $screeningFormat['ScreeningFormat']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($screeningFormat['Piece'])):?>
	...
	<?php
		$i = 0;
		foreach ($screeningFormat['Piece'] as $piece):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
